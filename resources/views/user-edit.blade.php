                    ...
                    <div class="row mx-2 mt-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="">
                                    <input class="form-control form-control-alternative" type="text" placeholder="First Name"
                                    name="first-name">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="">
                                    <input class="form-control form-control-alternative" type="text" placeholder="Last Name"
                                    name="last-name">
                                </div>
                            </div>
                        </div>
